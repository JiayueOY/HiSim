...
from hisim.components import heat_pump_pvbased
...
def basic_household__pvbased_explicit(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    ...
    # Build occupancy
    my_occupancy = occupancy.Occupancy(profile_name=occupancy_profile,
    ...
    my_base_electricity_load_profile = sumbuilder.ElectricityGrid(name="BaseLoad",
                                                                  grid=[my_occupancy, "Subtract",
                                                                        my_photovoltaic_system],
                                                                  my_simulation_parameters=my_simulation_parameters)
    ...
    my_heat_pump_pvbased_controller = heat_pump_pvbased.HeatPumpController(t_air_heating=t_air_heating,
                                                           t_air_cooling=t_air_cooling,
                                                           offset=offset,
                                                           mode=hp_mode,
                                                           my_simulation_parameters=my_simulation_parameters)
    my_heat_pump_pvbased_controller.connect_input(my_heat_pump_pvbased_controller.TemperatureMean,
                                          my_building.ComponentName,
                                          my_building.TemperatureMean)
    my_heat_pump_pvbased_controller.connect_input(my_heat_pump_pvbased_controller.ElectricityInput,
                                          my_base_electricity_load_profile.ComponentName,
                                          my_base_electricity_load_profile.ElectricityOutput)
    my_heat_pump_pvbased_controller.connect_input(my_heat_pump_pvbased_controller.DiffuseHorizontalIrradiance,
                                          my_building.ComponentName,
                                          my_building.DiffuseHorizontalIrradiance)
    my_heat_pump_pvbased_controller.connect_input(my_heat_pump_pvbased_controller.GlobalHorizontalIrradiance,
                                          my_building.ComponentName,
                                          my_building.GlobalHorizontalIrradiance)

    my_sim.add_component(my_heat_pump_pvbased_controller)

    my_heat_pump_pvbased = heat_pump_pvbased.HeatPump(manufacturer=hp_manufacturer,
                                      name=hp_name,
                                      min_operation_time=hp_min_operation_time,
                                      min_idle_time=hp_min_idle_time,
                                      my_simulation_parameters=my_simulation_parameters)
    my_heat_pump_pvbased.connect_input(my_heat_pump_pvbased.State,
                               my_heat_pump_pvbased_controller.ComponentName,
                               my_heat_pump_pvbased_controller.State)
    my_heat_pump_pvbased.connect_input(my_heat_pump_pvbased.TemperatureOutside,
                               my_weather.ComponentName,
                               my_weather.TemperatureOutside)



    my_sim.add_component(my_heat_pump_pvbased)

    my_building.connect_input(my_building.ThermalEnergyDelivered,
                              my_heat_pump_pvbased.ComponentName,
                              my_heat_pump_pvbased.ThermalEnergyDelivered)
...
def basic_household_with_default_connections(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    ...
    my_heat_pump_pvbased_controller = heat_pump_pvbased.HeatPumpController(t_air_heating=t_air_heating,
                                                           ...
                                                           mode=hp_mode,
                                                           my_simulation_parameters=my_simulation_parameters)
    my_heat_pump_pvbased_controller.connect_only_predefined_connections(my_building)
    ...
    my_heat_pump_pvbased = heat_pump_pvbased.HeatPump(manufacturer=hp_manufacturer,
                                      ...
                                      min_idle_time=hp_min_idle_time,
                                      my_simulation_parameters=my_simulation_parameters)
    my_heat_pump_pvbased.connect_only_predefined_connections(my_weather, my_heat_pump_pvbased_controller)
