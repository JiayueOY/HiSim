...
HISIMPATH : Dict[str,Any]      = {"results": os.path.join(hisim_abs_path, "results"),
                   ...
                   "weather": {"Aachen": os.path.join(hisim_inputs,
                               ...
                               "SEVILLE": os.path.join(hisim_inputs,
                                                      ...
                                                      "Seville",
                                                      "Seville"),
                               "ATHENS": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Athens",
                                                      "Athens"),
                               "BELGRADE": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Belgrade",
                                                      "Belgrade"),
                               "CYPRUS": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Cyprus",
                                                      "Cyprus"),
                               "LJUBLIANA": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Ljubljana",
                                                      "Ljubljana"),
                               "MILAN": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Milan",
                                                      "Milan"),
                               "SARAJEVO": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Sarajevo",
                                                      "Sarajevo"),
                               "VRANJE": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB",
                                                      "Vranje",
                                                      "Vranje"),

                               "FR": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Paris",
                                                      "403286_48.85_2.34_2019"),
                               "DE": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Potsdam",
                                                      "742114_52.41_13.06_2019"),
                               "PL": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Warsaw",
                                                      "1138443_52.25_21.02_2019"),
                               "SE": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Stockholm",
                                                      "984998_59.33_18.06_2019"),
                               "NO": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Oslo",
                                                      "653025_59.93_10.74_2019"),
                               "RS": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Belgrad",
                                                      "1108363_44.77_20.46_2019"),
                               "IT": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Rome",
                                                      "718838_41.89_12.50_2019"),
                               "GB": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "London",
                                                      "337089_51.49_-0.10_2019"),
                               "CY": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Nicosia",
                                                      "1809004_35.17_33.38_2019"),
                               "GR": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Athens",
                                                      "1291832_37.97_23.74_2019"),
                               "IE": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Dublin",
                                                      "165308_53.37_-6.26_2019"),
                               "SI": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Ljubljana",
                                                      "808557_46.05_14.50_2019"),
                               "CZ": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Prague",
                                                      "804583_50.09_14.42_2019"),
                               "AT": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Viana",
                                                      "902141_48.21_16.38_2019"),
                               "HU": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Budapest",
                                                      "1035927_47.49_19.06_2019"),
                               "BE": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Uccle",
                                                      "454992_50.81_4.34_2019"),
                               "ES": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Malaga",
                                                      "213028_36.73_-4.42_2019"),
                               "DK": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Copenhagen",
                                                      "721796_55.69_12.58_2019"),
                               "NL": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Amsterdam",
                                                      "469536_52.37_4.90_2019"),
                               "BG": os.path.join(hisim_inputs,
                                                      "weather",
                                                      "NSRDB_15min",
                                                      "Sofia",
                                                      "1267064_42.69_23.30_2019"),
                               },
                   ...
                   "smart_devices": os.path.join( hisim_inputs,
                                                  "loadprofiles",
...
def get_weather_data_path(location: str) -> str:
    """
    Get the full path to the weather data file for a given location.

    Parameters
    ----------
    location : str
        The name of the location for which to retrieve the weather data path.

    Returns
    -------
    str
        The full path to the weather data file.
    """
    weather_paths = HISIMPATH["weather"]
    if location in weather_paths:
        return weather_paths[location]
    else:
        raise ValueError(f"Weather data path for location '{location}' not found.")
