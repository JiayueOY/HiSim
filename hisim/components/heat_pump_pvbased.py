...
class HeatPump(cp.Component):
    ...
    def get_weather_default_connections(self):
        ...
        connections.append(
            cp.ComponentConnection(HeatPump.TemperatureOutside, weather_classname, Weather.TemperatureOutside))
        return connections
...
class HeatPumpController(cp.Component):
    ...
    def get_building_default_connections(self):
        ...
        connections.append(
            cp.ComponentConnection(HeatPumpController.TemperatureMean, building_classname, Building.TemperatureMean))
        return connections
    ...
    def get_weather_default_connections(self):
        ...
        connections.append(
            cp.ComponentConnection(HeatPump.TemperatureOutside, weather_classname, Weather.TemperatureOutside))
        connections.append(
            cp.ComponentConnection(HeatPumpController.DiffuseHorizontalIrradiance, weather_classname,
                                                  Weather.DiffuseHorizontalIrradiance))
        connections.append(
            cp.ComponentConnection(HeatPumpController.GlobalHorizontalIrradiance, weather_classname,
